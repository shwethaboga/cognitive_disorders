...
public class ManageChild extends JFrame {
	private static final long serialVersionUID = 1L;
	static ManageChild frame;
	...
	public ManageChild() {
		...
		JLabel lblSection = new JLabel("Manage Child");
		lblSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
		
		JButton btnAdd = new JButton("Add Child");
