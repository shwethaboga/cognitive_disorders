...
public class ManageSymptoms extends JFrame {
	private static final long serialVersionUID = 1L;
	static ManageSymptoms frame;
	...
	public ManageSymptoms() {
		...
		JButton btnAdd = new JButton("Add Symptom");
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			AddSymptom.main(new String[]{});
			frame.dispose();
			}
		});
		btnAdd.setFont(new Font("Tahoma", Font.PLAIN, 13));
		
		JButton btnSUpdate = new JButton("Modify Symptom details");
		...
		JButton btnSDelete = new JButton("Delete Symptom");
		...
		JButton btnView = new JButton("View All Symptoms");
